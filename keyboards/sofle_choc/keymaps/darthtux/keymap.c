...
[Base] = LAYOUT(
    ...
    KC_LCTL, KC_LALT, KC_LGUI, KC_SPC,  _______,                             _______,  KC_ENT,  KC_RCMD, KC_RGUI, KC_RCTL
),
[Mouse] = LAYOUT(
...
[MAC_SHORTS] = LAYOUT(
    ...
    _______,   _______,   LGUI(KC_Z), LGUI(KC_V),    LGUI(KC_C),       _______,                            _______,     _______,     _______,    _______,    _______,      _______,
    _______,   _______,   _______,     _______,        LGUI(KC_X),       _______,   KC_MPLY, KC_MUTE,     _______,     _______,     _______,    _______,    _______,      _______,
    _______, _______, _______, _______, _______,             _______, _______,  _______,  _______, _______
)
};
