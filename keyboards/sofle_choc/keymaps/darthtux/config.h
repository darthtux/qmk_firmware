...
#ifdef OLED_ENABLE
#   define OLED_FONT_H "keyboards/sofle_choc/keymaps/darthtux/glcdfont.c"
#endif
...
// key combos must be pushed in order specaified
#define COMBO_STRICT_TIMERS
