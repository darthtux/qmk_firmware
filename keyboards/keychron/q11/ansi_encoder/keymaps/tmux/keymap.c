...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_91_ansi(
        ...
        RM_VALD,  KC_LCTL,  MO(Symbols),        KC_LOPT,  KC_LCMD,       MT(MOD_LSFT,KC_SPC),                           KC_ENT,              LCTL(KC_TAB),  LGUI(KC_TAB),   LALT(KC_BSPC),           KC_LEFT,  KC_DOWN,  KC_RGHT),
    ...
    [TMUX] = LAYOUT_91_ansi(
        CG_TOGG,  _______,  _______,    _______,    _______,    _______,    _______,     _______,           _______,            _______,            _______,   _______,   _______,    _______,  _______,  _______,   _______,
        _______,  _______,  _______,    _______,    _______,    _______,    tmux_0,      tmux_1,            tmux_2,             tmux_3,             tmux_4,               tmux_5,   _______,    _______,  _______,             _______,
        _______,  _______,  _______,    _______,    _______,    _______,    _______,     tmux_create,       tmux_copy,          tmux_rename,        _______,              tmux_close_window,    _______,    _______,  _______,             _______,
        _______,  _______,  _______,    _______,    _______,    _______,    _______,     tmux_next_pane,    tmux_vertical,      tmux_horizontal,    tmux_pane_to_window,  tmux_close_pane,   _______,              _______,             _______,
