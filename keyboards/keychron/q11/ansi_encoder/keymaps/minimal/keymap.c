...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_91_ansi(
        ...
        RM_PREV,  KC_CAPS,  LT(Movement,KC_A),  KC_S,     KC_D,     LT(Shortcuts,KC_F),  KC_G,     KC_H,     LT(Symbols,KC_J),   KC_K,     KC_L,     KC_SCLN,     KC_QUOT,              KC_ENT,             KC_HOME,
        RM_VALU,  KC_LSFT,                      KC_Z,     KC_X,     KC_C,     KC_V,      KC_B,     KC_N,               KC_M,     KC_COMM,  KC_DOT,      KC_SLSH,              KC_RSFT,  KC_UP,
        RM_VALD,  KC_LCTL,  MO(Symbols),        KC_LOPT,  KC_LCMD,       MT(MOD_LGUI,KC_SPC),                        LT(Numbers,KC_ENT),      KC_RCMD,  MO(Symbols), KC_RCTL,    KC_LEFT,  KC_DOWN,  KC_RGHT),
    ...
    [Movement] = LAYOUT_91_ansi(
        _______,  _______,  _______,  _______,  _______,    _______,    _______,     _______,    _______,    _______,    _______,   _______,   _______,    _______,  _______,  _______,   _______,
        _______,  _______,  _______,  _______,  _______,    _______,    _______,     _______,    _______,    _______,    _______,   _______,   _______,    _______,  _______,             _______,
        _______,  _______,  _______,  KC_BSPC,  KC_UP,      KC_DELETE,    _______,     _______,    MS_BTN1,    MS_UP,      MS_BTN2,   _______,   _______,    _______,  _______,             _______,
        _______,  _______,  _______,  KC_LEFT,  KC_DOWN,    KC_RIGHT,     _______,     _______,    MS_LEFT,    MS_DOWN,    MS_RGHT,   _______,   _______,              _______,             _______,
        _______,  _______,  _______,  KC_TAB,   KC_ESC,     _______,      _______,     _______,    MS_WHLD,    _______,    MS_WHLU,   _______,              _______,  _______,
        _______,  _______,  _______,  _______,  _______,        _______,                         _______,             _______, _______, _______,  _______,  _______,  _______),
    ...
    [Shortcuts] = LAYOUT_91_ansi(
        ...
        _______,  _______,  _______,  _______,  _______,    _______,    _______,     _______,    _______,    _______,    _______,   _______,   _______,    _______,  _______,             _______,
        _______,  _______,  _______,  _______,  _______,   _______,    _______,     _______,    _______,    _______,    _______,   _______,   _______,    _______,  _______,             _______,
        _______,  _______,  _______,  _______,  _______,   _______,    _______,     _______,    LALT(KC_BSPC),    _______,    _______,   _______,   _______,              _______,             _______,
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    ...
    [Movement]   = { ENCODER_CCW_CW(RM_VALD, RM_VALU), ENCODER_CCW_CW(RM_VALD, RM_VALU) },
