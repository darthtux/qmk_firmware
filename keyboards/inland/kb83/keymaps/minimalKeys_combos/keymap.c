...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_B] = LAYOUT( /* Base */
		...
		KC_LSFT,    KC_Z,      KC_X,      KC_C,            KC_V,                KC_B,      KC_N,                KC_M,                 MT(MOD_LGUI, KC_COMM),  MT(MOD_LALT, KC_DOT),      MT(MOD_LCTL, KC_SLSH),    KC_RSFT,  KC_UP,                  KC_END, 
		KC_LALT,    KC_LGUI,   KC_LCTL,              MT(MOD_LSFT, KC_SPC),                         KC_RALT,              MO(SYMBOLS), KC_RCTL,    KC_LEFT,      KC_DOWN,    KC_RGHT),
    ...
    [MAC_B] = LAYOUT( /* FN */
		...
		KC_LSFT,    KC_Z,          KC_X,    KC_C,    KC_V,      KC_B,    KC_N,    KC_M,                MT(MOD_LGUI, KC_COMM),   MT(MOD_LALT, KC_DOT),      MT(MOD_LCTL, KC_SLSH),    KC_RSFT,   KC_UP,    KC_END, 
		KC_LCTL,    KC_LALT,       KC_LGUI,          MT(MOD_LSFT, KC_SPC),                              KC_RGUI,    MO(SYMBOLS), KC_RCTL,    KC_LEFT,   KC_DOWN,  KC_RGHT),
    ...
    [SYMBOLS] = LAYOUT( /* FN */
		_______, _______,   _______,    _______,    _______,  _______, _______, _______, _______, _______, _______, _______, _______, _______,       _______, 
		_______, _______,   _______,    _______,    _______,  _______, _______, _______, _______, _______, _______, _______, _______, _______,       _______, 
		_______, KC_LBRC,   KC_RBRC,    KC_EQUAL,   KC_DQUO,  _______, _______, _______, _______, _______, _______, _______, _______, _______,       _______, 
		_______, KC_LCBR,   KC_RCBR,    KC_BSLS,    KC_PIPE,  _______, _______, _______, _______, _______, _______, _______, _______,                _______, 
		_______, KC_LABK,   KC_RABK,    KC_PLUS,    KC_PMNS,  _______, _______, _______, _______, _______, _______, _______,               _______,  _______, 
		_______, _______, _______,                   _______,                            _______, _______, _______,      _______, _______, _______),
